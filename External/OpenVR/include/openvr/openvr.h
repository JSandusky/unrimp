...
// TODO(co) Changed for dynamic linking
#ifdef OPENVR_DEFINERUNTIMELINKING
	#define VR_INTERFACE
#else
	#define VR_INTERFACE extern
#endif
/*
#ifdef VR_API_EXPORT
...
namespace vr
{
	...
	*/
	VR_INTERFACE bool (VR_CALLTYPE *VR_IsHmdPresent)();	// TODO(co) Changed for dynamic linking

	/** Returns true if the OpenVR runtime is installed. */
	VR_INTERFACE bool (VR_CALLTYPE *VR_IsRuntimeInstalled)();	// TODO(co) Changed for dynamic linking

	/** Returns where the OpenVR runtime is installed. */
	VR_INTERFACE const char *(VR_CALLTYPE *VR_RuntimePath)();	// TODO(co) Changed for dynamic linking

	/** Returns the name of the enum value for an EVRInitError. This function may be called outside of VR_Init()/VR_Shutdown(). */
	VR_INTERFACE const char *(VR_CALLTYPE *VR_GetVRInitErrorAsSymbol)( EVRInitError error );	// TODO(co) Changed for dynamic linking
	...
	* use that as a key to look up their own localized error message. This function may be called outside of VR_Init()/VR_Shutdown(). */
	VR_INTERFACE const char *(VR_CALLTYPE *VR_GetVRInitErrorAsEnglishDescription)( EVRInitError error );	// TODO(co) Changed for dynamic linking

	/** Returns the interface of the specified version. This method must be called after VR_Init. The
	* pointer returned is valid until VR_Shutdown is called.
	*/
	VR_INTERFACE void *(VR_CALLTYPE *VR_GetGenericInterface)( const char *pchInterfaceVersion, EVRInitError *peError );	// TODO(co) Changed for dynamic linking

	/** Returns whether the interface of the specified version exists.
	*/
	VR_INTERFACE bool (VR_CALLTYPE *VR_IsInterfaceVersionValid)( const char *pchInterfaceVersion );	// TODO(co) Changed for dynamic linking

	/** Returns a token that represents whether the VR interface handles need to be reloaded */
	VR_INTERFACE uint32_t (VR_CALLTYPE *VR_GetInitToken)();	// TODO(co) Changed for dynamic linking
	...
	VR_INTERFACE uint32_t (VR_CALLTYPE *VR_InitInternal)( EVRInitError *peError, EVRApplicationType eApplicationType );	// TODO(co) Changed for dynamic linking
	VR_INTERFACE void (VR_CALLTYPE *VR_ShutdownInternal)();	// TODO(co) Changed for dynamic linking
